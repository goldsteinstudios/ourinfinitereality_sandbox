...
cp "$REPO/ddj/canonical/chapters/chapter01.md" "$CURRENT_DIR/09_ddj_chapter01.md"
cp "$REPO/ddj/canonical/chapters/chapter05.md" "$CURRENT_DIR/10_ddj_chapter05.md"
cp "$REPO/ddj/canonical/chapters/chapter11.md" "$CURRENT_DIR/11_ddj_chapter11.md"
cp "$REPO/ddj/canonical/chapters/chapter16.md" "$CURRENT_DIR/12_ddj_chapter16.md"
cp "$REPO/ddj/canonical/chapters/chapter40.md" "$CURRENT_DIR/13_ddj_chapter40.md"
cp "$REPO/ddj/canonical/chapters/chapter42.md" "$CURRENT_DIR/14_ddj_chapter42.md"
cp "$REPO/ddj/canonical/chapters/chapter51.md" "$CURRENT_DIR/15_ddj_chapter51.md"
cp "$REPO/ddj/canonical/chapters/chapter81.md" "$CURRENT_DIR/16_ddj_chapter81.md"

# DDJ Structural Translations (with confidence tracking)
cp "$REPO/src/content/translations/chapter-01.md" "$CURRENT_DIR/17_trans_chapter01.md"
cp "$REPO/src/content/translations/chapter-02.md" "$CURRENT_DIR/18_trans_chapter02.md"
cp "$REPO/src/content/translations/chapter-08.md" "$CURRENT_DIR/19_trans_chapter08.md"
cp "$REPO/src/content/translations/chapter-11.md" "$CURRENT_DIR/20_trans_chapter11.md"
cp "$REPO/src/content/translations/chapter-22.md" "$CURRENT_DIR/21_trans_chapter22.md"
cp "$REPO/src/content/translations/chapter-25.md" "$CURRENT_DIR/22_trans_chapter25.md"
cp "$REPO/src/content/translations/chapter-40.md" "$CURRENT_DIR/23_trans_chapter40.md"
cp "$REPO/src/content/translations/chapter-42.md" "$CURRENT_DIR/24_trans_chapter42.md"
cp "$REPO/src/content/translations/chapter-64.md" "$CURRENT_DIR/25_trans_chapter64.md"
cp "$REPO/src/content/translations/chapter-76.md" "$CURRENT_DIR/26_trans_chapter76.md"

# Essays
cp "$REPO/consolidated/essays/euler_tao_identity.md" "$CURRENT_DIR/27_euler_tao_identity.md"
cp "$REPO/src/content/essays/between-e-and-phi.md" "$CURRENT_DIR/28_between_e_and_phi.md"

# Assessments
cp "$REPO/rsm/canonical/between_e_phi_assessment.md" "$CURRENT_DIR/29_between_e_phi_assessment.md"
...
| # | File | Description |
|---|------|-------------|
| 05 | lexicon_intro.md | RSM v0.988 alignment header |
...
### DDJ Canonical Chapters (09-16)
| # | File | Description |
|---|------|-------------|
| 09 | ddj_chapter01.md | Coordinate system (名=i, 玄=0, 有=1) |
| 10 | ddj_chapter05.md | Bellows principle (橐籥, 虛/不屈/守中) |
| 11 | ddj_chapter11.md | Scythe principle (利₁/利₂/用 distinction) |
| 12 | ddj_chapter16.md | Return to root (復 operator, 常 cascade) |
| 13 | ddj_chapter40.md | Oscillation engine (反=+1) |
| 14 | ddj_chapter42.md | Generative sequence (道生一 = P₀→O₁) |
| 15 | ddj_chapter51.md | 道生/德畜 formula (玄德) |
| 16 | ddj_chapter81.md | Closure validation (三 paradoxes) |

### DDJ Structural Translations (17-26)
*With confidence tracking and RSM mappings*
| # | File | Description |
|---|------|-------------|
| 17 | trans_chapter01.md | Chapter 1 — Coordinate system |
| 18 | trans_chapter02.md | Chapter 2 — Co-generation of poles (相生) |
| 19 | trans_chapter08.md | Chapter 8 — Water principle |
| 20 | trans_chapter11.md | Chapter 11 — Wheel, pot, room |
| 21 | trans_chapter22.md | Chapter 22 — Yielding overcomes |
| 22 | trans_chapter25.md | Chapter 25 — Four greats (大→逝→遠→反) |
| 23 | trans_chapter40.md | Chapter 40 — Return is movement |
| 24 | trans_chapter42.md | Chapter 42 — Generative sequence |
...
for f in 01_rsm.md 02_operators.md 03_notation_guide.md 04_recursive_structural_model.md \
         ...
         09_ddj_chapter01.md 10_ddj_chapter05.md 11_ddj_chapter11.md 12_ddj_chapter16.md \
         13_ddj_chapter40.md 14_ddj_chapter42.md 15_ddj_chapter51.md 16_ddj_chapter81.md \
         17_trans_chapter01.md 18_trans_chapter02.md 19_trans_chapter08.md 20_trans_chapter11.md \
         21_trans_chapter22.md 22_trans_chapter25.md 23_trans_chapter40.md 24_trans_chapter42.md \
         25_trans_chapter64.md 26_trans_chapter76.md \
         27_euler_tao_identity.md 28_between_e_and_phi.md \
         29_between_e_phi_assessment.md; do
    echo -e "# ═══════════════════════════════════════════════════════════════\n# FILE: $f\n# ═══════════════════════════════════════════════════════════════\n" >> "$DOCSET_DIR/rsm_complete.md"
