# chapter25_sphere_proof_2025-12-01.md

notebook: Our Infinite Reality v.971
source_id: fcff2110-0da5-4709-b3d6-d752dd403d0e
...
It has no 名 (measurement/projection)
You can't project what has no frame to project from
字之曰道 — "Its style-name is 'pattern'"
字 is relational designation (like a courtesy name)
道 is how it relates to things, not what it IS
強為之名曰大 — "Compelled to name it, [call it] 'infinity'"
Forced to project something
大 is the closest approximation: the unbounded field
--------------------------------------------------------------------------------
The Sphere Proof
