# 00_lexicon_introduction.md

notebook: Our Infinite Reality v.972
source_id: 8a55a647-5373-469a-aa67-12018d84b2fd
...
Identify its substrate radical (what domain?)
Identify its operator radical (what transformation?)
Apply the transformation grammar
Check cross-references in Concept Index
To trace a concept across characters:
Go to Part IV: Concept Index
Find the operational principle
See all characters encoding that principle
Trace radical patterns across the set
To verify a reading:
Check Guodian validation column
Check chapter references
See if radical algebra predicts the meaning
--------------------------------------------------------------------------------
A Note on Method
