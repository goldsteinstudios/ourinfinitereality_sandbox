...
**Deeper** — into the wheel's components:
- The Hub: where thirty spokes meet nothing
- The Spokes: tension radiating from center to edge
- The Rim: the closure that makes the circuit complete
