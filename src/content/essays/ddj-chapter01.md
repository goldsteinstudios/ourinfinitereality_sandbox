...
> **RSM v0.986 Reference:** This chapter establishes the foundational framework. Key operator mappings: 名 = i (orthogonal distinction), 玄 = 0 (unoccupiable center), 有 = 1 (structural unity).
...
| Character | Structural Reading | RSM Mapping |
|-----------|-------------------|----------------|
