---
title: "The Standing Wave Pattern"
subtitle: "How guitar strings, electron orbitals, and tree rings share a shape"
...
*Connects RSM v0.986, DDJ Chapter 25, and Wave Physics*
...
| Character | What It Describes |
|-----------|-------------------|
| **大** (dà) | Origin, totality, starting point |
| **逝** (shì) | Extension outward, going forth |
| **遠** (yuǎn) | Maximum distance, reaching boundary |
| **反** (fǎn) | Return, reversal |
...
| Season | What Happens |
|--------|--------------|
| **Spring** | Dormancy breaks, sap rises |
| **Summer** | Growth, extension, differentiation |
| **Autumn** | Growth stops, maximum extension |
| **Winter** | Return to dormancy, consolidation |
...
| System | Precision Window |
|--------|------------------|
| Schrödinger equation | Quantitative predictions, eigenvalues, probability amplitudes |
| Chapter 25 | Compressed notation, qualitative structure |
| Tree rings | Physical instantiation, readable in cellulose |
| Guitar strings | Direct sensory access, audible |
