...
|-----------|-------------------|
| 道 | dao (untranslated — exists in both modes) |
| 可 | manifest / explicit mode |
| 常 | implicit / frame-independent mode / pre-distinction |
| 非 | ←非→ divergence from shared center |
| 名 | distinction / the operation that differentiates |
| 無 | nothing / void |
| 有 | something / form |
...
| 玄 | paradoxical origin / center where axes meet |
