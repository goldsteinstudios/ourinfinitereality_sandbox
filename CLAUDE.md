...
## The Chains (v9.51 — current working set; NOT sealed)

> **CANON UPDATE (2026-08-04, patch sets 1–4 + session drafting):** current canon is **v9.51**, and the
...
1. **v9.51 is the current working set** (markdown canonical at `rsm/canonical/chains/v9.5/`) —
