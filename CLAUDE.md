...
## The Chains (v9.5 — current working set; NOT sealed)

> **CANON UPDATE (2026-08-03, patch sets 1–3 + session drafting):** current canon is **v9.5**, and the
...
1. **v9.5 is the current working set** (markdown canonical at `rsm/canonical/chains/v9.5/`) —
