...
| **潰** (kuì) | G₁ (gradient) | e (extension) | Continuous overflow outward |
| **遠** (yuǎn) | P₁ (periphery) | i (rotation) | Reaching boundary condition |
| **反** (fǎn) | Polarity | π (opposition) | Structural co-emergence of opposite |
...
|-----------|----------|-------------------|------------------|
| 逝 | 辶 + 折 | Walking radical + fold/break | Continuous motion away |
| 遠 | 辶 + 袁 | Walking radical + garment edge | Motion to boundary |
| 反 | 又 + 厂 | Hand + cliff | Bouncing back, reversal |
...
*Based on RSM translation framework with Guodian manuscript validation*
*Revised to incorporate polarity principle from "Loom and Forge" paper*
