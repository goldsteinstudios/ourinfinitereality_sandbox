...
The implicit register now forces revolution rather than positing it. Bₙ does not obtain, so the two mode-dominant regions of a frame have no path between them; the relation between them is carried by Gₙ revolving about Bₙ, which realizes the mode-swap as motion. This is the one structural fact in the chain with real reach into physics, because it makes a single question askable of any system: what is the circulation doing?
